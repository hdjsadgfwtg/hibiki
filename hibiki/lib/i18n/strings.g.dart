...
class _StringsEn implements BaseTranslations<AppLocale, _StringsEn> {
	...
	String get srt_import_pick_srt => 'Pick Subtitle File (choose one with EPUB)';
	...
	String get srt_import_pick_epub => 'Pick EPUB (choose one with subtitles)';
	...
	String get srt_import_missing_input => 'Please pick an EPUB or subtitle file (one required)';
	String get srt_import_conflict => 'Import EPUB and subtitles separately. To attach subtitles to an existing EPUB, long-press the book on the shelf.';
...
class _StringsZhCn implements _StringsEn {
	...
	@override String get app_locale_warning => '社区扩展和增强由各自作者维护，部分内容可能仍以原语言显示。';
	...
	@override String get srt_import_pick_srt => '选择字幕文件（与 EPUB 二选一）';
	...
	@override String get srt_import_pick_epub => '选择 EPUB（与字幕二选一）';
	...
	@override String get srt_import_missing_input => '请选择 EPUB 或字幕文件（必须至少一项）';
	@override String get srt_import_conflict => '请分别导入 EPUB 和字幕；给 EPUB 挂字幕请在书架长按该书';
...
extension on _StringsEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'srt_import_pick_srt': return 'Pick Subtitle File (choose one with EPUB)';
			...
			case 'srt_import_pick_epub': return 'Pick EPUB (choose one with subtitles)';
			...
			case 'srt_import_missing_input': return 'Please pick an EPUB or subtitle file (one required)';
			case 'srt_import_conflict': return 'Import EPUB and subtitles separately. To attach subtitles to an existing EPUB, long-press the book on the shelf.';
...
extension on _StringsZhCn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'app_locale_warning': return '社区扩展和增强由各自作者维护，部分内容可能仍以原语言显示。';
			...
			case 'srt_import_pick_srt': return '选择字幕文件（与 EPUB 二选一）';
			...
			case 'srt_import_pick_epub': return '选择 EPUB（与字幕二选一）';
			...
			case 'srt_import_missing_input': return '请选择 EPUB 或字幕文件（必须至少一项）';
			case 'srt_import_conflict': return '请分别导入 EPUB 和字幕；给 EPUB 挂字幕请在书架长按该书';
