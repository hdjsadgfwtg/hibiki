...
class _StringsEn implements BaseTranslations<AppLocale, _StringsEn> {
	...
	String get srt_import_pick_srt => 'Pick Subtitle File (optional)';
	...
	String get srt_import_pick_epub => 'Pick EPUB (optional)';
	...
	String get srt_import_missing_input => 'Please pick an EPUB or subtitle file';
...
class _StringsZhCn implements _StringsEn {
	...
	@override String get srt_import_pick_srt => '选择字幕文件（可选）';
	...
	@override String get srt_import_pick_epub => '选择 EPUB（可选）';
	...
	@override String get srt_import_missing_input => '请选择 EPUB 或字幕文件';
...
extension on _StringsEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'srt_import_pick_srt': return 'Pick Subtitle File (optional)';
			...
			case 'srt_import_pick_epub': return 'Pick EPUB (optional)';
			...
			case 'srt_import_missing_input': return 'Please pick an EPUB or subtitle file';
...
extension on _StringsZhCn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'srt_import_pick_srt': return '选择字幕文件（可选）';
			...
			case 'srt_import_pick_epub': return '选择 EPUB（可选）';
			...
			case 'srt_import_missing_input': return '请选择 EPUB 或字幕文件';
