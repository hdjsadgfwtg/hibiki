...
class _JidoujishoSelectableTextSelectionGestureDetectorBuilder
    extends TextSelectionGestureDetectorBuilder {
  _JidoujishoSelectableTextSelectionGestureDetectorBuilder({
    required _JidoujishoSelectableTextState state,
  })  : _state = state,
        super(delegate: state);

  final _JidoujishoSelectableTextState _state;
...
/// A class to handle text selection programmatically for the [JidoujishoSelectableText]
/// widget.
class JidoujishoSelectableTextController {
  _TextSpanEditingController? _textSpanEditingController;
...
///
/// The [JidoujishoSelectableText] widget displays a string of text with a single style.
...
/// {@end-tool}
///
/// Using the [JidoujishoSelectableText.rich] constructor, the [JidoujishoSelectableText] widget can
...
/// ## Interactivity
///
/// To make [JidoujishoSelectableText] react to touch events, use callback [onTap] to achieve
...
class JidoujishoSelectableText extends StatefulWidget {
  ...
  @override
  State<JidoujishoSelectableText> createState() =>
      _JidoujishoSelectableTextState();
...
class _JidoujishoSelectableTextState extends State<JidoujishoSelectableText>
  ...
  late _JidoujishoSelectableTextSelectionGestureDetectorBuilder
